...
public static class CurveBuilder
{
        ...
        float startValue = 0f, float endValue = 1f)
    {
        ...
        // calculate the proper values for tangets, etc.
        //
        ...
        float startValue = 0f, float endValue = 1f)
    {
        ...
        // and the AnimationUtility class will calculate the proper values for tangets,
        // etc.
        ...
        float startTime = 0f, float endTime = 1f, float startValue = 0f, float endValue = 1f)
    {
        ...
        // tangents [(outWeight, outTanget) and (inWeight, inTangent)] for the control
